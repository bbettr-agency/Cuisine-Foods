    ...
    <section className="relative overflow-hidden border-b border-line">
      ...
      <Container className="grid items-center gap-10 py-10 lg:grid-cols-[1.1fr_0.9fr] lg:py-16">
        ...
        <div ref={zoneRef} onMouseMove={onMove} onMouseLeave={reset} className="relative flex justify-center [perspective:1200px]">
          <motion.div aria-hidden className="absolute bottom-[8%] left-1/2 -z-0 h-10 w-[52%] -translate-x-1/2 rounded-[50%] bg-ink/25 blur-2xl" style={reduce ? undefined : { x: shadowX }} />
          <motion.div
            className="relative w-[60%] max-w-[290px] [transform-style:preserve-3d] sm:w-[50%] lg:w-full lg:max-w-[340px]"
